...
export class CreateSolicitudDto {
    ...
    @ApiProperty({
        example: 'Estoy muy interesado en unirme a su comunidad solidaria. He estado siguiendo sus actividades y me encantaría contribuir y participar activamente.',
