...
export abstract class ISeguidorService {
    abstract create(createSeguidorDto: CreateSeguidorDto): Promise<UsuarioSeguimiento>;
    ...
    abstract seguir(createSeguidorDto: CreateSeguidorDto[]): Promise<UsuarioSeguimiento>;
}
